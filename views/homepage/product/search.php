<div class="row">
    ...
    <form action="<?php BASE_URL . 'san-pham/search-product'?>" method="post">
        ...
        <div class="">
            <a name="btnSearch" href="<?= BASE_URL. 'search-product' ?>" class="btn btn-danger me-2">Tìm kiếm</a>
            <a name="btnSearchAll" class="btn btn-success me-2">Tất cả</a>
        </div>
    </form>
</div>
<div class="container d-flex flex-wrap gap-4 p-3">
    <?php foreach ($product_search as $pro) : ?>
