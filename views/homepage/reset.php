<form action="<?= CLIENT_URL . 'send-email/submit' ?>" method="post">
    <div class="col-6 offset-3">
        <div class="form-group">
            ...
            <input type="text" name="recceiver" value="<?php if (isset($recceiver)) {
                                                            echo $recceiver;
                                                        } ?>" class="form-control" placeholder="địa chỉ email người nhận">
            <span style="color: red;"><?php if (isset($_SESSION['recceiver'])) {
