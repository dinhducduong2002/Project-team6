...
<body>
    <div class="notfound-copy">
        ...
        <p>Có vẻ như bạn đang nhầm đường dẫn URL ?</p>
        <p><a href="<?= BASE_URL ?>">Home</a></p>
        <p><a href="<?= BASE_URL ?>">Locations</a></p>
        <p><a href="<?= BASE_URL ?>">Weekly Specials</a></p>
        <p><a href="<?= BASE_URL ?>">Corporate</a></p>
    </div>

    <svg aria-labelledby="Starry sky" alt="Starry sky" class="starry-sky">
        <title id="svgtitle2">project_team6</title>
        <!-- STARS START -->
