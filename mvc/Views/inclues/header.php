    ...
    <div class="container">
      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
          <a class="logo m-4" href="#"><img src="./mvc/views/images/logo.jpg" alt="50" height="50"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="account">
              <a href="HomeController/login" class="btn border border-secondary me-2">ĐĂNG NHẬP</a>
            <a href="HomeController/register" class="btn border border-secondary me-2">ĐĂNG KÍ</a>
            </div>
          </div>
        </div>
      </nav>
